...
namespace CodePulse.API.Repositories.Implmentation
{
    public class ImageRepository : IImageRepository
    {
        ...
        {
            //1) uplaod the image to API/Images folder

            //ContentRootPath->CodePulse.API
            //Images->Folder
            //$"{blogImage.FileName}{blogImage.FileExtension}" ->Create a file with file name and extension
            var localPath = Path.Combine(webHostEnvironment.ContentRootPath, "Images", $"{blogImage.FileName}{blogImage.FileExtension}");

            //this will create the file in the folder
